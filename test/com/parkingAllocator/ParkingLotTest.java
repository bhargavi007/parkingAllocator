...
import com.parkingAllocator.ParkingLot;
...
public class ParkingLotTest {
    ...
    public void createParkingLot() throws Exception {
        ...
        assertEquals(6, parkingLot.LOT_SIZE);
...
//        assertEquals("Sorry,parkinglotisnotcreated", outContent.toString().trim().replace(" ", ""));
    ...
    @Test
    public void getRegistrationNumbersGivenColor() throws Exception {
        parkingLot.getRegistrationNumbersGivenColor("White");
        parkingLot.createParkingLot("6");
        parkingLot.park("KA-01-HH-1234", "White");
        parkingLot.park("KA-01-HH-9999", "White");
        parkingLot.getRegistrationNumbersGivenColor("White");
        ...
        parkingLot.getRegistrationNumbersGivenColor("Red");
        assertEquals("Sorry,parkinglotisnotcreated\n" +
                "\n" +
                "Createdaparkinglotwith6slots\n" +
                "\n" +
    ...
    @Test
    public void getSlotNumbersGivenColor() throws Exception {
        parkingLot.getSlotNumbersGivenColor("White");
        parkingLot.createParkingLot("6");
        parkingLot.park("KA-01-HH-1234", "White");
        parkingLot.park("KA-01-HH-9999", "White");
        parkingLot.getSlotNumbersGivenColor("White");
        ...
        parkingLot.getSlotNumbersGivenColor("Red");
        assertEquals("Sorry,parkinglotisnotcreated\n" +
                "\n" +
                "Createdaparkinglotwith6slots\n" +
                "\n" +
    ...
    @Test
    public void getSlotNumberGivenRegNo() throws Exception {
        parkingLot.getSlotNumberGivenRegNo("KA-01-HH-1234");
        parkingLot.createParkingLot("6");
        parkingLot.park("KA-01-HH-1234", "White");
        parkingLot.park("KA-01-HH-9999", "White");
        parkingLot.getSlotNumberGivenRegNo("KA-01-HH-1234");
        ...
        parkingLot.getSlotNumberGivenRegNo("KA-01-HH-9999");
        assertEquals("Sorry,parkinglotisnotcreated\n" +
                "\n" +
        		    "Createdaparkinglotwith6slots\n" +
                "\n" +
